...
type SubscriptionResolver interface {
	UserUpdated(ctx context.Context) (<-chan *model.UserUpdated, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "UserUpdated.info":
		if e.complexity.UserUpdated.Info == nil {
			break
		}

		return e.complexity.UserUpdated.Info(childComplexity), true

	case "UserUpdated.user":
		if e.complexity.UserUpdated.User == nil {
			break
		}

		return e.complexity.UserUpdated.User(childComplexity), true
...
func (ec *executionContext) field_Mutation_createUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateUserInput2gographqlᚋgraphᚋmodelᚐCreateUserInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Subscription_userUpdated(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	return func() graphql.Marshaler {
		res, ok := <-resTmp.(<-chan *model.UserUpdated)
		if !ok {
			return nil
		}
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNUserUpdated2ᚖgographqlᚋgraphᚋmodelᚐUserUpdated(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) _UserUpdated_user(ctx context.Context, field graphql.CollectedField, obj *model.UserUpdated) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _UserUpdated_info(ctx context.Context, field graphql.CollectedField, obj *model.UserUpdated) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
var userUpdatedImplementors = []string{"UserUpdated"}

func (ec *executionContext) _UserUpdated(ctx context.Context, sel ast.SelectionSet, obj *model.UserUpdated) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, userUpdatedImplementors)
	out := graphql.NewFieldSet(fields)
	var invalids uint32
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("UserUpdated")
		case "user":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._UserUpdated_user(ctx, field, obj)
			}
		...
		case "info":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._UserUpdated_info(ctx, field, obj)
			}
...
func (ec *executionContext) unmarshalNCreateUserInput2gographqlᚋgraphᚋmodelᚐCreateUserInput(ctx context.Context, v interface{}) (model.CreateUserInput, error) {
...
func (ec *executionContext) marshalNUserUpdated2gographqlᚋgraphᚋmodelᚐUserUpdated(ctx context.Context, sel ast.SelectionSet, v model.UserUpdated) graphql.Marshaler {
	return ec._UserUpdated(ctx, sel, &v)
}

func (ec *executionContext) marshalNUserUpdated2ᚖgographqlᚋgraphᚋmodelᚐUserUpdated(ctx context.Context, sel ast.SelectionSet, v *model.UserUpdated) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
